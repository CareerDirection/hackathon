...
function finishExam(){
  ...
  let msg="";
  if(r.final>=90) msg="Congratulations! You are now Eligible for 2nd round interview for Paid Internship (Champion).";
  else if(r.final>=70) msg="Congratulations! You are now Eligible to choose 2nd round interview for Paid Internship or Unpaid Internship (Winner).";
  else msg="Congratulations! You are now Eligible to choose Unpaid Internship (Participation).";
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  if(isMobile()){
    alert("Hackathon allowed only on Laptop/Desktop.");
